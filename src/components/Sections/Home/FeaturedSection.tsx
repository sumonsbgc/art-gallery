...
const FeaturedSection = ({ needToRefetch, setNeedToRefetch }: FeaturedSectionProps) => {
  ...
  return (
    <section className="sm:pt-[130px] pt-16 mb-20">
      <div className="featured-gallery-wrapper flex x2l:gap-7 xl:gap-5 lg:gap-4 sm:px-7 px-7">
        <div className="flex flex-col items-start w-[292px] shrink-0 sm:w-[355px] x2l:ml-56 xl:ml-24 lg:ml-20 sm:px-7">
        ...
        <div className="featured-gallery w-full">
