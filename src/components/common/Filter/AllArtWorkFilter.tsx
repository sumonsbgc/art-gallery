...
// redux
import { useGetAllArtWorkArtsQuery } from '@/redux/features/arts/artsApi';
...
const AllArtWorkFilter = ({
  ...
  const { data, isSuccess, isLoading, isError, error } = useGetAllArtWorkArtsQuery(
    {
      ...params,
...
export default AllArtWorkFilter;
