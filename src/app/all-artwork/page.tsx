...
// redux
import { useLazyGetAllArtWorkArtsQuery } from '@/redux/features/arts/artsApi';

// types
import { ArtItem } from '@/types/art';
import Wrapper from '@/components/layout/Wrapper';
import ArtCardSkeletonList from '@/components/common/Skeleton/ArtCardSkeletonList';
import AllArtWorkFilter from '@/components/common/Filter/AllArtWorkFilter';
import { getTotalItems } from '@/utils';

function AllArtWork() {
  const [getArts] = useLazyGetAllArtWorkArtsQuery();
      ...
      <div className="w-full">
        <Wrapper maxWidth="1550px">
          <div className="w-full flex sm:flex-col items-center justify-between text-center mt-4">
            <h2 className="text-2xl font-[600] text-black">All Art Work</h2>
