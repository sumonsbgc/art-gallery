...
import ArtsFilter from '@/components/common/Filter/ArtsFilter';
import Wrapper from '@/components/layout/Wrapper';

// redux
import { useLazyGetArtsQuery } from '@/redux/features/arts/artsApi';
...
const NewArrivals = () => {
  const [getArts] = useLazyGetArtsQuery();
      ...
      <div className="w-full">
        <Wrapper maxWidth="1550px">
          <div className="w-full flex sm:flex-col items-center justify-between text-center mt-4">
            <h2 className="text-2xl font-[600] text-black">New Arrivals</h2>
